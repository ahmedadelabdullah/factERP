...
@section('content')
    ...
    <form class="row invoice_details w-75 m-auto" id="invoice_details_offices" method="POST" action="{{route('tex.store')}}" enctype="multipart/form-data">
        @csrf
        <div class="col-md-4">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <select class="form-control office d-inline-block" name="office_id" id="office_id" required>
        ...
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-7">
                    <input type="number" class="form-control total_pieces" readonly placeholder="NO.Pieces" name="total_rolls">
                </div>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-7">
                    <input type="number" class="form-control sub_total" readonly placeholder="Sub_Total" name="total_amount">
...
{{--                        <label for="inputPassword5" class="form-label  ">Model Name</label>--}}
                        <select class="form-control office d-inline-block mt-md-4 mt-sm-5" name="model[0]" id="office_id" required>
...
{{--            <label for="inputPassword5" class="form-label">NO.Pieces</label>--}}
            <input type="number" placeholder="quantity" class="form-control quantity mt-md-4 mt-sm-5" id="" name="quantity[0]" step="any">
        </div>
        <div class="col-md-2">
{{--            <label for="inputPassword5" class="form-label">Unit Price</label>--}}
            <input type="number" placeholder="Unit Price" class="form-control unit_price mt-md-4 mt-sm-5" id="" name="unit_price[0]">
        </div>
        <div class="col-md-2">
{{--            <label for="inputPassword12" class="form-label">Quantity</label>--}}
            <input type="number" placeholder="price" class="price form-control mt-md-4 mt-sm-5" id="" name="price[0]" readonly>
        </div>
